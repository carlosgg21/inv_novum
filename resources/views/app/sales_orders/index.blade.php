                    ...
                    <tbody>
                        @forelse($salesOrders as $salesOrder)
                            <tr>
                                ...
                                <td>{{ $salesOrder->order_date ? format_date($salesOrder->order_date, 'd/m/Y') : '-' }}
                                </td>
                                <td class="text-center">
                                    <span class="badge badge-secondary">{{ $salesOrder->salesOrderItems->count() }}</span>
                                ...
                                <td style="text-align: center; vertical-align: middle;">
                                    <span
                                        class="badge {{ $salesOrder->status == 'entered' ? 'badge-primary badge-pill' : 'badge-dark badge-pill' }}">
                                        {{ $salesOrder->status == 'entered' ? 'Entered' : 'Not Entered' }}
                                    </span>
                                </td>

                                <td>{{ $salesOrder->invoice_date ? format_date($salesOrder->invoice_date, 'd/m/Y') : '-' }}
                                </td>
