...
<div class="row border border-primary">
    ...
    <x-inputs.group class="col-sm-12 m-t-5">
        ...
        <x-inputs.select2 name="product_id_select" required style="width: 100%; height:36px;" disabled>
    ...
    <x-inputs.group class="col-sm-4">
        ...
        <x-inputs.number name="cost_price" id="cost_price"
            :value="old('cost_price', ($editing ? $inventory->cost_price : ''))" max="10000" min="1" step="0.01"
            placeholder="Cost Price"></x-inputs.number>
    </x-inputs.group>

    <x-inputs.group class="col-sm-4 ">
        <label for="SellPrice">Sell Price</label>
        <x-inputs.number name="sell_price" id="sell_price"
            :value="old('sell_price', ($editing ? $inventory->sell_price : ''))" max="10000" min="1" step="0.01"
            placeholder="Sell Price" required></x-inputs.number>
    </x-inputs.group>
