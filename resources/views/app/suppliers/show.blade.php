    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="mt-4">
                ...
                <div class="mb-4">
                    <h5>@lang('crud.suppliers.inputs.email')</h5>
                    <span>{{ $supplier->email ?? '-' }}</span>
                </div>
                <div class="mb-4">
                    <h5>@lang('crud.suppliers.inputs.note')</h5>
                ...
                <div class="mb-4">
                    <h5>@lang('crud.suppliers.inputs.country_id')</h5>
                    <span>{{ optional($supplier->country)->name ?? '-' }}</span>
                </div>
            </div>
